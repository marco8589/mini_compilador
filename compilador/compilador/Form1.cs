...
namespace compilador
{
    public partial class compilador : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
          ...
          //  lexico.Text = "";
            ...
            if (contador_errores > 0)
            {
               ...
               // this.lexico.Text = "ERRORES LEXICOS TIENE: " + contador_errores;
                //this.lexico.Visible = true;
            }
            else
            {
            ...
            {
                //lexema
                //  MessageBox.Show(row.Cells["c1"].Value.ToString());
                //token
                /// MessageBox.Show(row.Cells["c2"].Value.ToString());
               // MessageBox.Show("\"");
                switch (row.Cells["c1"].Value.ToString())
                {
                    case "imprimir":
                        if (codigo.IndexOf("imprimir") > 0)
                        {
                            //MessageBox.Show(codigo.Substring(codigo.IndexOf("ver"), 5));
                            Boolean comillas = false;
                            Boolean comilla1 = false;
                            Boolean comilla2 = false;
                            String contenido = "";
                            int f = 0;

                            for (f = 0; comillas == false; f++)
                            {
                                String asd = codigo.Substring(codigo.IndexOf("imprimir") + f, 1) ;
                                if (codigo.Substring(codigo.IndexOf("imprimir") + f, 1) == "\"" && comilla1 == true && comilla2 == false)
                                {
                                    comilla2 = true;
                                }
                                ...
                                if (comilla1 == true)
                                {
                                    contenido = contenido + codigo.Substring(codigo.IndexOf("imprimir") + f, 1);
                                }

                                if (codigo.Substring(codigo.IndexOf("imprimir") + f, 1) == "\"" && comilla1 == false)
                                {
                                    comilla1 = true;
                                }
                                //
                            ...
                            codigo = codigo.Replace("imprimir \"" + contenido + "\" ;", "MessageBox.Show(\"" + contenido + "\") ;");
                    ...
                    case "cadena":
                        if (row.Cells["c2"].Value.ToString() == "RESERVADO")
                        {
                            codigo = codigo.Replace("cadena", "String");
                        }
                        break;
                    ...
                    case "entero":
                        if (row.Cells["c2"].Value.ToString() == "RESERVADO")
                        {
                            codigo = codigo.Replace("entero", "int");
                        }
                        break;
                    ...
                    case "booleano":
                        if (row.Cells["c2"].Value.ToString() == "RESERVADO")
                        {
                            codigo = codigo.Replace("booleano", "Boolean");
                        }
                        break;
                    ...
                    case "decimal":
                        if (row.Cells["c2"].Value.ToString() == "RESERVADO")
                        {
                            codigo = codigo.Replace("decimal", "Boolean");
                        }
                        break;
        ...
        public void VerificarLexema()
        {
            ...
            string[] reservado = { "inicio", "proceso", "fin", "si", "imprimir", "mientras", "entero", "cadena" };
            ...
            for (recorrido = 0; recorrido < lexi_a_sint.Length; recorrido++)
            {
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido], "inicio"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido], ";"))
                    {
                        ...
                        dataGridView2.Rows.Add("Correcto", "INICIALIZACION --> inicio ; <-- " + " Fila: " + num_linea[recorrido]);
                        recorrido += 1;
                        inicio_correcto = "1";
                    }
                    else
                    {
                        dataGridView2.Rows.Add("Error", "Falta punto y coma" + " Fila: " + num_linea[recorrido]);
                    }
                }
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido], "proceso"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido], ";"))
                    {
                        ...
                        dataGridView2.Rows.Add("Correcto", "INICIALIZACION --> proceso ; <-- " + "Fila: " + num_linea[recorrido]);
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido], "fin"))
                {
                    ...
                    {
                        fin_hay = "1";
                        dataGridView2.Rows.Add("Correcto", "FINALIZACION --> fin ; <--" + " Fila: " + num_linea[recorrido]);
                        recorrido += 1;

                    }
                    else
                    {
                        //  dataGridView2.Rows.Add("Error", "Falta punto y coma" + " Fila: " + num_linea[recorrido] + " COLUMNA: " + num_columna[recorrido]);
                    }
                }
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "="))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^[0-9]+$[0-9]?"))
                        {
                            ...
                            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], ";"))
                            {
                                ...
                                if (existe == "si")
                                {
                                    dataGridView3.Rows.Add("Error", "El nombre de la variable existe" + " Fila: " + num_linea[recorrido]);
                                }
                                if (existe == "no")
                                {
                                    ...
                                    dataGridView3.Rows.Add("Correcto", "Asignacion de variable entera" + " Fila: " + num_linea[recorrido]);
                            ...
                            else
                            {
                                ...
                                dataGridView2.Rows.Add("Error", "Falta punto y coma" + " Fila: " + num_linea[recorrido] ); recorrido_sum -= 1;
                            }

                        }
                        else
                        {
                            dataGridView2.Rows.Add("Error", "Falta un numero" + " Fila: " + num_linea[recorrido] ); recorrido_sum -= 1;
                        }

                    }
                    else
                    {
                        dataGridView2.Rows.Add("Error", "Falta signo de igual" + " Fila: " + num_linea[recorrido] ); recorrido_sum -= 1;
                    }
                }
                else
                {
                    dataGridView2.Rows.Add("Error", "Falta variable" + " Fila: " + num_linea[recorrido]); recorrido_sum -= 1;
                }
                recorrido = recorrido_sum;
            }
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "="))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^\".*\"$"))
                        {
                            ...
                            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], ";"))
                            {
                                ...
                                if (existe == "si")
                                {
                                    dataGridView2.Rows.Add("Error", "El nombre de la variable existe" + " Fila: " + num_linea[recorrido]);
                                }
                                if (existe == "no")
                                {
                                    variables[contador_variables] = lexi_a_sint[recorrido_sum - 3];
                                    ...
                                    contador_variables += 1;
                                    dataGridView3.Rows.Add("Correcto", "Asignacion de variable de cadena" + " Fila: " + num_linea[recorrido]);
                        ...
                        {
                            dataGridView2.Rows.Add("Error", "Falta una cadena" + " Fila: " + num_linea[recorrido]); recorrido_sum -= 1;
                        }
        ...
        public void estruc_imprimir()
        {
            //inicia reconocimento de ver

            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "imprimir"))
            {
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^\".*\"$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], ";"))
                    {
                        dataGridView3.Rows.Add("Correcto", "Mostrar en pantalla imprimir" + " Fila: " + num_linea[recorrido_sum]);
            ...
            // recorrido_sum -= 1;
        }//fin public void estruc_imprimir



        public void estruc_imprimirx()
        {
            ...
            //finaliza reconocimento de ver
            // recorrido_sum -= 1;
        }//fin public void estruc_imprimirx
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "si"))
            {
                ...
                if (lexi_a_sint[recorrido_sum].Equals("("))
                {
                    ...
                    if (lexi_a_sint[recorrido_sum].Equals(")"))
                    {
                        ...
                        {
                            recorrido_sum += 1;
                            this.estruc_imprimir_dentro_de_si();
                            recorrido_sum += 1;
                            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "}"))
                            {
                                dataGridView2.Rows.Add("Correcto", " Condicion SI " + "  Fila: " + num_linea[recorrido_sum]);
                            ...
                            {
                                dataGridView2.Rows.Add("Error", "Falta cierre de llaves" + " Fila: " + num_linea[recorrido_sum] ); recorrido_sum -= 1;
                            }

                        }
                        else
                        {
                            dataGridView2.Rows.Add("Error", "Falta abrir de llaves" + " Fila: " + num_linea[recorrido_sum] ); recorrido_sum -= 1;
                        }

                    }
                    else
                    {
                        dataGridView2.Rows.Add("Error", "Falta cerrar parentesis" + " Fila: " + num_linea[recorrido_sum] ); recorrido_sum -= 1;
                    }
                }
                else
                {
                    dataGridView2.Rows.Add("Error", "Falta abrir parentesis" + " Fila: " + num_linea[recorrido_sum] ); recorrido_sum -= 1;
                }
                ...
                if (lexi_a_sint[recorrido_sum].Equals("("))
                {
                    ...
                    if (lexi_a_sint[recorrido_sum].Equals(")"))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "{"))
                        {
                            ...
                            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "}"))
                            {
                                dataGridView2.Rows.Add("Correcto", "MIENTRAS ( ) { }" + " FINALIZACION Fila: " + num_linea[recorrido_sum]);
                            }
                            else
                            {
                                dataGridView2.Rows.Add("Error", "Falta cierre de llaves" + " Fila: " + num_linea[recorrido_sum] ); recorrido_sum -= 1;
        ...
        public void estruc_imprimir_dentro_de_si()
        {
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "imprimir"))
            {
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^\".*\"$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], ";"))
                    {
                        dataGridView2.Rows.Add("Correcto", "Mostrar en pantalla imprimir" + " Fila: " + num_linea[recorrido_sum]);
                    ...
                    {
                        dataGridView2.Rows.Add("Error", "Falta punto y coma" + " Fila: " + num_linea[recorrido_sum] ); recorrido_sum -= 1;
                    }

                }
                else
                {
                    dataGridView2.Rows.Add("Error", "Falta una cadena" + " Fila: " + num_linea[recorrido_sum] ); recorrido_sum -= 1;
                }
        ...
        }//fin public void estruc_imprimir_dentro_de_si

        public void estruc_comparacion()
        {
            //inicia reconocimento deComparacion
            string existe = "no";
            string existe2 = "no";
            string tipo = "ninguno";
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$|^[0-9]+$[0-9]?|^\".*\"$"))
            {
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$"))
                {
                    ...
                    if (existe == "no")
                    {
                        dataGridView2.Rows.Add("Error", "Variable no decladara" + " Fila: " + num_linea[recorrido] );
                    }
                }
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^[<|>]$|^==$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$|^[0-9]+$[0-9]?|^\".*\"$"))
                    {
                        ...
                        else
                        {
                            ...
                            if (tipo == tipo2)
                            {
                                dataGridView3.Rows.Add("Correcto", "Comparacion" + " Fila: " + num_linea[recorrido_sum]);
                            ...
                            {
                                dataGridView3.Rows.Add("Error", " Diferentes tipos de datos " + " Fila: " + num_linea[recorrido_sum]);
                            }
                    ...
                    {
                        dataGridView2.Rows.Add("Error", "Se esperaba algun dato o variable" + " Fila: " + num_linea[recorrido_sum] ); recorrido_sum -= 1;
                    }

                }
                else
                {
                    dataGridView2.Rows.Add("Error", "Falta comparador" + " Fila: " + num_linea[recorrido_sum] ); recorrido_sum -= 1;
                }
        ...
        }//finaliza reconocimento deComparacion
        ...
        {
            //inicia reconocimento deComparacionmientras
            string existe = "no";
            string existe2 = "no";
            string tipo = "ninguno";
            string tipo2 = "ninguno";
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^[<|>]$|^==$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$|^[0-9]+$[0-9]?|^\".*\"$"))
                    {
                        ...
                        else
                        {
                            ...
                            if (tipo == tipo2)
                            {
                                dataGridView2.Rows.Add("Correcto", "Comparacion" + " Fila: " + num_linea[recorrido_sum]);
                            ...
                            {
                                dataGridView2.Rows.Add("Error", " Diferentes tipos de datos " + " Fila: " + num_linea[recorrido_sum]);
                            }
